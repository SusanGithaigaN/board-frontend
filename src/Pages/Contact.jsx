        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
          ...
          <div className="one">
            ...
            <p className="text-sm text-gray-800">
              We're here to help you every step of the way. Reach out to us with
              any questions, feedback, or support needs, and we'll get back to
              you promptly.
            </p>
            {/* cards */}
          ...
          <div className="two">
            <form
              id="contactForm"
              className="space-y-8 p-4 md:p-8 bg-[#309689]/10 rounded-xl"
            >
